...
(() => {
  ...
  (() => {
    ...
    function f(e) {
      ...
      for (; (n = r.shift()); ) {
        ...
        if (Array.isArray(o) || (o && o.constructor === Object)) {
          ...
          void 0 !== o &&
            (null === o && (o = ""),
            (t += "&" + [e, o].map(encodeURIComponent).join("=")));
      }
      return t.substr(1);
    }
    function g(e) {
        ...
        .reduce((e, t) => {
          ...
          if (r) {
            !(function (e, t, r) {
              ...
              for (let i = 0; i < n; i++) {
                let n = t[i];
                !n && Array.isArray(e) && (n = e.length.toString()),
    ...
    function y(e = "", t) {
      ...
      const n = e.indexOf("?");
      return (
        -1 !== n && ((t = Object.assign(m(e), t)), (r = r.substr(0, n))),
        r + "?" + f(t)
      );
    }
    function U(e, t) {
